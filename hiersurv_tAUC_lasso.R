...
source("/users/hchen/new_work/Simulations/data_gen_lasso.R")
library(BB)
library(glmnet)
...
save(comp.result, file = paste("/users/hchen/new_work/Simulations/lasso_tAUC_output/", "output_tAUC", k, ".RData", sep = ""))
