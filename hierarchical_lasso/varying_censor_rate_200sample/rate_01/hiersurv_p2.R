...
source("/users/hchen/new_work/Simulations/hierarchical_lasso/varying_censor_rate_200sample/rate_01/data_gen_p2.R")
library(BB)
library(glmnet)
...
save(comp.result, file = paste("/users/hchen/new_work/Simulations/hierarchical_lasso/varying_censor_rate_200sample/rate_01/out_p2/", "output", k, ".RData", sep = ""))
