...
source("/users/hchen/new_work/Simulations/hierarchical_lasso/varying_censor_rate/rate_01/data_gen_lasso.R")
library(BB)
library(glmnet)
...
save(comp.result, file = paste("/users/hchen/new_work/Simulations/hierarchical_lasso/varying_censor_rate/rate_01/out_lasso/", "output", k, ".RData", sep = ""))
