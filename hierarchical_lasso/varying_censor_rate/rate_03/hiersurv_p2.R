...
source("/users/hchen/new_work/Simulations/hierarchical_lasso/varying_censor_rate/rate_03/data_gen_p2.R")
library(BB)
library(glmnet)
...
save(comp.result, file = paste("/users/hchen/new_work/Simulations/hierarchical_lasso/varying_censor_rate/rate_03/out_p2/", "output", k, ".RData", sep = ""))
