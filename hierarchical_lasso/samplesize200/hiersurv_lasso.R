...
source("/users/hchen/new_work/Simulations/hierarchical_lasso/samplesize200/data_gen_lasso.R")
library(BB)
library(glmnet)
...
save(comp.result, file = paste("/users/hchen/new_work/Simulations/hierarchical_lasso/samplesize200/out_lasso/", "output", k, ".RData", sep = ""))
